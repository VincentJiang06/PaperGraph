...
(docs/00 Search Program Adoption). Stage B (triangulation, V-SRC-04) remains
design-frozen and is NOT adopted — the triangulation section below and V-SRC-04
are informational only until a later adoption entry.**
