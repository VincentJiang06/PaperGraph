...
def ingest_result(paths: Paths, output_file: str, work_item_id: str, actor: str | None = None) -> dict[str, Any]:
    ...
    assigned_docs, assigned_eus = _archive_result(paths, result, dres_id, extracted_by)
...
def _archive_result(paths: Paths, result: Any, dres_id: str, extracted_by: str) -> tuple[list[str], list[str]]:
