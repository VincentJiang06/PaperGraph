"""c2: coal deaths per TWh (OWID, 2021). Reads the shared dataset, writes the metric."""
import csv
import json
...
(RUN / "metrics" / "c2.json").write_text(json.dumps({"value": value}) + "\n")
print(f"coal_deaths_per_twh={value}")
