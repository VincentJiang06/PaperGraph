"""c4: wind deaths per TWh (OWID, 2021). Reads the shared dataset, writes the metric."""
import csv
import json
...
(RUN / "metrics" / "c4.json").write_text(json.dumps({"value": value}) + "\n")
print(f"wind_deaths_per_twh={value}")
