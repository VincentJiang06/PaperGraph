...
共 **26 个 `.md` 文件**、**11,675 行**（`ls research/v2/*.md | wc -l` 与 `wc -l` 实测，2026-08-17）。
两层分工：
...
| **11,675** 行 | `wc -l research/v2/*.md` 的 total 行 | verified（自算） |
...
**语料基线**：`research/v2/`（**26 文件 / 25 个研究维度 / 11,675 行**，全部产出于 2026-08-17）
