...
`./gates/run_all.sh all` 当前 **32/32 全绿**，退出码判定。产品代码约 3500 行，门与外部测试另有约 6400 行：
...
| [07-ATTACK-LEDGER.md](07-ATTACK-LEDGER.md) | **攻击台账**——每轮的靶标指纹、种子命中率、findings 全量、裁决与修复状态 | 1818 行 / R1 收 164 条 |
